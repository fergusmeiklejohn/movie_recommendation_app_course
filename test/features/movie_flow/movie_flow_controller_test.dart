...
void main() {
  ...
  setUp(() {
    ...
    container = ProviderContainer(overrides: [
      movieServiceProvider.overrideWithProvider(Provider((ref) => mockedMovieService)),
    ]);
  ...
  group('MovieFlowControllerTests -', () {
    test('Given genres When Toggle Then that genre should be toggled', () async {
      ...
      expect(container.read(movieFlowControllerProvider).genres, AsyncValue.data([toggledGenre]));
    });
